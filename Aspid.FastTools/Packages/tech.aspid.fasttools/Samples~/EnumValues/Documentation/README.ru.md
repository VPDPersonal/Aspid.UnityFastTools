...
2. Войдите в Play Mode: **Walker** проходит семь плиток, оставляя непрерывную цветную линию. Её старый конец сокращается через две секунды. На горячем металле персонаж движется быстрее, на мокрой траве — медленнее.
